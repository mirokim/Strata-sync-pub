...
<div class="cover">
  <div class="cover-tag">Sandbox Map &middot; Report</div>
  <div class="cover-title">{_html_mod.escape(title)}</div>
  <div class="cover-date">{date_str}</div>
</div>
<div class="body">
{body_html}
  <div class="footer">Sandbox Map &mdash; {date_str} 생성</div>
</div></body></html>"""
...
<footer>Generated by Sandbox Map Bot · MiroFish</footer>
</body>
</html>"""
