...
const TOOLS: [string, string][] = [
  ...
  ['vault_propose', 'Record something tentative as a proposal in _agent/ — a person promotes it'],
  ['vault_proposals', 'List pending proposals'],
  ['vault_promote', 'Promote a proposal into the vault — after a person approves it'],
  ['vault_write', 'The normal way to record — create or update a document where it belongs; personal=true keeps it to you'],
